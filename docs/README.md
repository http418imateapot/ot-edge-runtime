...
| [`edgeconf-patterns.md`](edgeconf-patterns.md) | `edgeconf/patterns/` — fault-tolerant config-file message exchange patterns. Originally the `robust-config-exchange` repository. |

...
> 完整設計說明請見 [.github/SDD.md](../runtime/.github/SDD.md)。
...
- 版本單一來源：[`VERSION`](../runtime/VERSION)
- 變更紀錄：[`CHANGELOG.md`](../runtime/CHANGELOG.md)
- 安全政策：[`SECURITY.md`](../runtime/SECURITY.md)
- 貢獻指南：[`CONTRIBUTING.md`](../runtime/CONTRIBUTING.md)

...
進階版的 [edgeconf/patterns](edgeconf-patterns.md) 專案。填補「SQLite 太重、純文字檔太脆」之間的空隙，專為工廠自動化閘道器、AIoT 感測器集線器、邊緣運算節點等場景設計。

詳細架構與格式規格見 **[docs/SDD.md](../edgeconf/core/docs/SDD.md)**。
...
詳細規格見 [docs/SDD.md § 3](../edgeconf/core/docs/SDD.md)。
